...
export const CHANGELOG: Release[] = [
  {
    ...
    date: '2026-09-15',
    changes: [
      'First release. Everything a canvass needs day to day is here and running on the real list: the map, turfs, the door screen, follow-ups, lawn signs, offline canvassing, the printable sheet, texts and the reports.',
      'Still to come: coverage and support reports by ward and turf, CSV export, and in-app notifications.',
    ],
  },
  {
    version: '0.7.1',
  ...
  },
  {
    ...
    date: '2026-09-11',
    changes: [
      'Screens now show a placeholder shaped like the content that is loading, instead of a bare spinner.',
    ],
  },
  {
    version: '0.5.2',
    date: '2026-09-11',
    changes: [
      'The campaign website\u2019s sign-up form can now post straight into here \u2014 lawn sign requests arrive as real requests instead of an email.',
    ],
  },
  {
    version: '0.5.1',
